...
?>  
  ...
  <div class="container" >
         ...
         <nav class="navbar navbar-inverse bg-dark navbar-fixed-top gabanav">
       ...
       <nav class="navbar navbar-inverse  navbar-fixed-top gabanav">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav gabali">
                <li><a href="index.php">Home</a></li>
                <li><a href="consignment_form.php">create consignment</a></li>
                <li><a href="updatetruck_status.php">Truck status</a></li>
              </ul>
              <ul class="nav navbar-nav navbar-right">
